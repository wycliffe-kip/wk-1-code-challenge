    ...
    based on marks*/
        ...
        if (marks > 79) {
            ...
            grades = window.alert("The student's grade is: B");
        } else if (marks >= 50 && marks <= 59) {
            grades = window.alert("The student's grade is: C");
        } else if (marks >= 40 && marks <=49) {
            grades = window.alert("The student's grade is: D");
        } else {
            grades = window.alert("The student's grade is: E");
        }
